...
class SaleOrder(models.Model):
    ...
    discount_type = fields.Selection([('percent', 'Percentage'), ('amount', 'Amount')], string='Discount type',
                                     readonly=True, default='percent', compute="_discount_costumer")
    discount_rate = fields.Float('Discount Rate', digits=dp.get_precision('Account'),
                                 readonly=True, compute="_discount_costumer")
    ...
    def _discount_costumer(self):
        if self.partner_id:
            self.discount_type = self.partner_id.customer_discount
            self.discount_rate = self.partner_id.discount
