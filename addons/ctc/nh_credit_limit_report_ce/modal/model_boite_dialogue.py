...
class CreditLimitReport(models.TransientModel):
    _name= 'nh_credit_limit_report_ce.credit_limit_report_wizard'
    ...
    def generer_fichier(self):
        ...
        ln =8
        path = get_module_resource('nh_credit_limit_report_ce', 'static/template/customer_credit_limit.xlsx')
        ...
        current_date=time.strftime("%Y_%m_%d")
        chemin=get_module_resource('nh_credit_limit_report_ce', 'static', 'customer_credit_limit')
        ...
        return {
                    ...
                    'res_model' : 'nh_credit_limit_report_ce.credit_limit_report_wizard',
                    'view_mode' : 'form',
                    'view_type' : 'form',
                    'res_id' : self.id,
                    'views' : [(False, 'form')],
    ...
    def button_print_credit_limit_report(self):
        ...
        datas.update({
            ...
            'ids': self.ids,
            'elements':elements,
            'model': 'nh_credit_limit_report_ce.report_credit_limit'
                        
        })
        #return self.env['report'].get_action(self,'nh_credit_limit_report_ce.report_credit_limit', data=datas)
        #return self.env.ref('nh_credit_limit_report_ce.report_credit_limit').report_action(self, data=datas, config=False)
        return {
                    'type' : 'ir.actions.report',
                    'name':'nh_credit_limit_report_ce.report_credit_limit',
                    'res_model' : 'report.nh_credit_limit_report_ce.report_credit_limit',
                    'model' : 'report.nh_credit_limit_report_ce.report_credit_limit',
                    'report_type':'qweb-pdf',
                    'report_name':'nh_credit_limit_report_ce.report_credit_limit',
                    'data':datas,
